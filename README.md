# Hệ thống Hồ sơ số Mầm non — Trường MN Diễn Lợi

Bản triển khai cho **Trường Mầm non Diễn Lợi** (xã Quảng Châu, tỉnh Nghệ An).
...
```
├── index.html      Trang chính (chứa const API_URL riêng cho trường)
├── style.css       Định dạng giao diện (chung cho mọi trường)
├── app.js          Logic xử lý (chung cho mọi trường)
└── README.md       Tài liệu này
```

> Mã `Code.gs` được dán trực tiếp vào trình soạn thảo Apps Script của Google Sheet trường, không lưu trong repo này.
